        ...
        <div className='animate-fadeIn animate-duration-[5000ms]'>
            ...
            <div className='flex flex-col items-center'>
                <div className='flex flex-col justify-center items-center self-center border-zinc-600 w-10/12 mt-10 '>
                    ...
                    <div className='w-10/12 tracking-wide md:w-4/5 text-justify my-6'> I'm a highly resourceful and passionate Software Engineer and well-rounded IT Professional possessing expert knowledge of the Software Development lifecycle and a solid understanding of technologies required for the development and deployment of highly available and scalable applications, including their networks and infrastructure.
