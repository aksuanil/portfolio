...
export default function About() {
    return (
        <div className=''>
            <div class="block text-base tracking-tight text-gray-600 bg-gradient-to-r from-transparent via-zinc-600 to-transparent w-full bg-[length:80%_2px] bg-no-repeat bg-center pb-[6px]"/>
